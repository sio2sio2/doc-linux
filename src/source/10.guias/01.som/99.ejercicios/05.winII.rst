...
#. Debe crearse el siguiente conjunto de usuarios en un *Windows* 10 nuevo:
   ...
   + Respecto a las directivas de seguridad local:
   ...
   + Evitar que los alumnos puedan cambiar la configuración y acceder al panel
     de control.

     .. note:: Para ello neceita definir directivas de grupo aplicables sólo a
        grupos o usuarios. Consulte `este enlace
        <https://www.solvetic.com/tutoriales/article/2802-como-habilitar-directivas-de-grupo-en-windows-10-home/>`_
