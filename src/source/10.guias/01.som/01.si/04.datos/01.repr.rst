...
codificar en formato binario y determinado conjunto de caracteres. Hay distintos
sistemas de codificación:
...
**De ancho fijo**
   ...
   |ASCII|
      ...
      estos sistemas de codificación suele denominárseles |ASCII| extendido. Los
      más usados son:
...
**De ancho variable**
   Al contrario de los anteriores, todos los códigos binarios no tienen la misma
...
.. include:: /10.guias/01.som/99.ejercicios/010.repr.rst
