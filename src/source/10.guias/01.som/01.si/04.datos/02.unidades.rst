...
Una particularidad de las prefijos usados en la unidades de capacidad es que no representan múltiplos de **1000** (como es lo común en otro tipo de unidades), sino de **1024**, ya que al representar información binaria se prefiere que los prefijos representen alguna potencia de **2** y **1024** es 2\ :superscript:`10`.
...
Por fibra                        ~ 100Mb/s
Por |USB|\ 1                     ~ 10Mb/s  (12 Mb/s)
Por |USB|\ 2                     ~ 500Mb/s (480 Mb/s)
Por |USB|\ 3                     ~ 10Gb/s  (10 Gb/s la v3.1)
Por |ATA|                        ~ 100Mb/s
Por |SATA| III                   ~ 10Gb/s
Por |PCI|-E v3                     16Gb/s
Por 3G                           ~ 10 Mb/s
...
.. include:: /10.guias/01.som/99.ejercicios/011.unidades.rst
