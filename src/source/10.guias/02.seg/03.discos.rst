...
producto que comercializan. Cualquier pérdida o deteriodo puede suponer un daño
...
Sin embargo, los datos particulares de las organización son únicos y, en
consecuencia, ni se pueden crear y ni por lo general, recrear *ex novo*.

Por otra parte, la naturaleza personal de algunos datos los hace suscepcibles de
la leyes de protección de datos, que son muy estrictas, de obligado cumplimiento
...
datos. Por ejemplo, un apagón repentido puede provocar la corrupción del sistema
