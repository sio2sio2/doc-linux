...
arranques encontrados en todas las particiones |EFI| de todos los
dispositivos.
...
Para ilustrar su uso, recrearemos dos veces la tabla de particiones que hicimos
...
La tabla de particiones GPT compatible con |BIOS| podemos definirla así::

   $ /sbin/sgdisk -a 8 -n "0:40:2047" -t "0:0xef02" \
...
Por su parte, la tabla de particiones |GPT| compatible con |UEFI| podemos
hacerla así::

   $ /sbin/sgdisk -n "0:2048:+50M" -t "0:0xef00" \
                  -n "0:+0:+32M" -c "0:UNO" \
                  -n "0:+0:+2G" -t "0:0x0700" -c "0:DOS" \
                  -n "0:+0:+1G" -c "0:TRES" /tmp/disco.raw
