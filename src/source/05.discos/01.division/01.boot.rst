...
<boot-manager>` básico capaz de cargar programas y cargadores de arranque que se
encuentren en una partición de disco de tipo *EF00*\ [#]_ creada a ese efecto y
formateada típicamente en |FAT|. Se tratará de ello al estudiar el particionado.
