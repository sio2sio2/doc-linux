...
.. seealso:: Para la realización más cómoda de instantáneas y la conservación de
   varios estados sucesivos (y no únicamente uno como lo ilustrado aquí), revise
   más adelante :ref:`instantáneas con aprovisionamiento fino <snapper>`.
...
.. todo:: Explicar cómo funciona :deb:`snapper`.
