...
de disco. Por tanto, a lo anterior, debemos añadir::

   # mdadm --grow /dev/md0 --raid-devices=3

.. note:: Existe también la opción :kbd:`--add`, pero esta sólo añade el disco
   al |RAID| si al |RAID| le hemos aumentado previamente el número de
   dispositivos. En caso contrario, añade el disco como disco de reserva. Por
   otro lado, si al |RAID| se le aumenta el número de dispositivos, intentará
   añadir discos de reserva al |RAID|.
...
Ahora bien, si el proceso se deja aquí el |RAID|, aunque tenga discos para
asegurar la redundancia, quedará cojo y así lo mostrará :file:`/proc/mdstat`::

   # cat /proc/mdastat
   [... TODO: Pegar la salida ...::
