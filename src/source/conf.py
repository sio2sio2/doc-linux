...
# -*- coding: utf-8 -*-
#
# ServidorLinux documentation build configuration file, created by
# sphinx-quickstart on Wed Oct  5 16:19:44 2016.
#
...
project = 'ServidorLinux'
copyright = '2016, José Miguel Sánchez Alés'
...
#
# html_title = 'ServidorLinux v0.1.0'
...
htmlhelp_basename = 'ServidorLinuxdoc'
...
latex_documents = [
    (master_doc, 'ServidorLinux.tex', 'ServidorLinux Documentation',
     'José Miguel Sánchez Alés', 'manual'),
]
...
man_pages = [
    (master_doc, 'servidorlinux', 'ServidorLinux Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ServidorLinux', 'ServidorLinux Documentation',
     author, 'ServidorLinux', 'One line description of project.',
     'Miscellaneous'),
]
...
rst_epilog = """
.. |DNS| replace:: :abbr:`DNS (Domain Name Server)`
...
.. |RSAT| replace:: :abbr:`RSAT (Remote Server Administration Tools)`
.. |PAM| replace:: :abbr:`PAM (Pluggable Authentication Modules)`
.. |LDAP| replace:: :abbr:`LDAP (Lightweight Directory Access Protocol)`
.. |ACL| replace:: :abbr:`ACL (Access Control List)`
.. |SSH| replace:: :abbr:`SSH (Security SHell)`
