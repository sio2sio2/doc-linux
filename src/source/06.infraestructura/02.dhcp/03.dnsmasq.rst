...
donde en el servidor |DHCP| se sirven configuraciones para ambas redes y en
router que se separa ambas, se ha instalado el *software*::
...
esto determina que la petición se retransmita por esa interfaz y que por el
...
.. warning:: Tenga presente que en esta comunicación no tiene efecto enmascarar
   el tráfico que sale por la *eth0* del router que hace *relay* para que el
   ...
   o añade una entrada a su tabla de encaminamiento o la añade a su puerta de
