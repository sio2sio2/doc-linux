Preliminares
************
Antes de entrar de lleno en la configuración del servicio, es indispensable conocer el protocolo y los clientes.
...
.. todo:: Uso de :command:`host`, :command:`dig` y :kbd:`getent hosts`
