...
.. table:: **Categorías (facility)**
   ...
   4        auth      Sí      Mensajes de procesos de autenticación\ [#]_
...
.. [#] Los mensajes del núcleo también pueden ser revisados gracias al
   ...
   En *jessie*, la consulta con :command:`dmesg` puede realizarla cualquier
   usuario. Sin embargo, en *stretch* requerirá los permisos de *root*.
