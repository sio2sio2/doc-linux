...
Además, autenticar al cliente mediante certificados presenta otras ventajas
añadidas:

+ Se puede establecer una caducidad para los certificados.
+ Se pueden definir en los propios certificados limitaciones de uso: por
  ejemplo, prohibir que con el certificado se pueda tunelizar.
