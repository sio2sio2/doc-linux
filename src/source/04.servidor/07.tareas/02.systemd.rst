...
Antes de generalizar, ilustraremos su uso con el siguiente problema:
   ...
   :file:`${XDG_CONFIG_HOME}/mpv/watch_later` archivos con los
   ...
   simplemente se olvida y se borra, ya que no volverá a reproducirse y
   en consecuencia el archivo de su estado quedará perennemente almacenado
   mientras no se borre a mano.
