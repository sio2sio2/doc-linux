...
puede usarse para propósitos semenjantes, la de conexiones simultáneas, por lo
que la incluiremos dentro de este apartado.
...
.. warning:: La comprobación basta hacérsela al primer paquete y, además, es
   bastante costosa de hacer, por lo que los desarrolladores
   `recomiendan siempre restringirla al paquete que abre la conexión
