...
porque el particinado de este disco no es el más sencilla En cualquier caso:
...
Disco duro:
   ...
   Si nuestro sistema tuviera un particinado básico, simplemente tendríamos
...
:command:`lsblk`
   Un comando más elocuente y que nos muestra más a las claras cómo esan
...
**Tipo de sistema**
   ...
   dipositivo o partición (*ext3*, *xfs*, *ntfs*, *nfs*, etc). Puede ser *none*
...
.. include:: ../../ejercicios/03-dispositivos.rst
