...
:manpage:`cp`
   ...
   fichero que está referenciado a través de dos nombres (*nombre1* y
   *nombre2*). Al crear un enlace duro lo que estamos haciendo es crear una
   ...
   de ficheros, obtendremos un error. Supongamos que :file:`/home` y
   :file:`/tmp` están en distinto sistema de ficheros::
...
:manpage:`realpath`
   ...
   del archivo dado como argumento (que no tiene por qué)::
   ...
   Puede requerirse que el archivo exista incluyendo la opción :kbd:`-e`::
      ...
      realpath: «no.existe»: No existe el fichero o el directorio
