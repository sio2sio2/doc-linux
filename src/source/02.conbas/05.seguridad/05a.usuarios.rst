...
:file:`/etc/group`
   ...
   #. La *contraseña* de grupo. Esta contraseña sirve para dar acceso
      ...
      comando `newgrp`_). Por lo general, en vez de incluirse la contraseña, se
      incluye la letra ":kbd:`x`", que significa que lea la contraseña en el
      archivo :file:`/etc/gshadow`.
...
:file:`/etc/passwd`
   ...
   #. La **contraseña** que no suele encontrarse aquí, sino en :file:`/etc/shadow`.
      En su sustitución se escribe el carácter ":kbd:`x`".
