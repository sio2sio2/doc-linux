...
:command:`ps`
   ...
   .. warning:: Tenga presente que los efecto de filtro no son acomulativos.
...
:command:`pgrep`
   Permite obtener el |PID| de un proceso antendiendo a distintos criterios.
   ...
   lo que si se utilizan varios, :command:`pgrep` sólo deolverá aquellos que
   ...
   procesos, devuleve cuántos procesos en total. Por tanto, pasa saber cuántos
