...
:command:`pkill`
   ...
   <pgrep>`. Por tanto, podremos referirlos mediante su nombre, no su |PID|, y
   además podremos añadir otros criterios acomulativos de selección tal como se
   explicó para :command:`pgrep`::
