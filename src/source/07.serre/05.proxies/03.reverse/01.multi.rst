...
.. note:: :program:`haproxy`. en este caso, no actúa como *proxy* transparente,
   ...
   de la propia máquina. Si el origen de las peticiones para |VPN| y |SSH| nos fuera fundamental
   (en el servicio web se han resuleto vía cabeceras |HTTP|), podemos ponerlo
   a funcionar en :ref:`modo transparente <haproxy-transparent>`.
...
repositio de Github <https://github.com/erebe/wstunnel>`. Su uso es bastante
