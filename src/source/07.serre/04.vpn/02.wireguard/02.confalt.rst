...
**Servidor**
   ...
   * Utiliza la misma técnica de manipulación de las tablas de encanimamiento que
     :program:`wg-quick`.
   * El propio :program:`wstunnel` marca el tráfico para el encaminamiento evite
     que salga por el tunel.
   * Para definir la configuración del túnel, permite añadir una sección más al
