...
actualmente en vigor en España y que armonizas las normas sobre tratamiento de
datos personales en toda la Unión Europea.

Objeto y alcance
----------------
La finalidad de la normativa es proteger la intimidad, privacidad e integridad
de las personas para lo cual regula cómo deben tratarse los datos personales
y cómo debe llevarse a cabo cualquier transferencia de este tipo de datos para
que el intercambio sea seguro.

Es aplicable a toda empresa con sede en la Unión Europea o que recopile datos
de ciudadanos de la Unión Europea.

A estos efectos se considera :dfn:`dato personal` cualquier información de
texto, imagen o sonido que permita la identificación de una persona. No
obstante, la ley distingue unas **categorías especiales** que están
...
+ **Delegado de protección de datos** (|DPD|), que es es la persona encargada de
...
* **Agencia española de protección de datos** (|AEPD|), fundada en 1992 a raíz
  de la |LORTAD|, que es un organismo púiblico independiente encargado de velar por el cumplimiento de la
...
**Portabilidad**
   ...
   interesado poder cambiar de prestatario de un servicio fácilmente (p.e. un
...
personal se compromenten a cumplir una serie de obligaciones:
...
**Consentimiento explícito**
   ...
   datos, sino también que acepte con qué finalidad se recaben. Es más, si la
...
**Análisis de riesgos** y **evaluación de impacto**
   ...
   contramedidas de seguidad pertienentes; el |RGPD| exige realizar un *análisis
...
Régimen sancionador
-------------------
El incluplimiento de la normativa de protección de datos conlleva unas
...
**Infracciones graves**
   ...
   + No disponer del :ref:`registro de actividadades <registro-act>`.
...
**Infracciones leves**
   ...
   + Que el registro de actividades no incluya toda la información exgible.
...
.. [#] Por tanto, el derecho está intimamente relacionado con los navegadores.
