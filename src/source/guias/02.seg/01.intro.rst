...
.. todo:: Renombrar la unidad a "Seguridad informática"
...
de cuya definición, a su vez, deriva la necesidad de definir estas otros
conceptos:
...
Reparación
==========
Y de la parte de la reparación:
...
.. Apuntes de José Manuel:

.. todo:: Es preciso copletar este apartado con política de seguridad, análisis
   de riesgo, plan de contingencias y auditoría.
...
********************
.. todo:: Debe eliminarse este epígrafe cuando se actualice a la próxima
   versión ya que migra a la siguiente unidad.

.. seealso:: Sus contenidos están desarrollados en :ref:`este epígrafe
