...
Es muy importante también tener presente que el *software* no es eterno y, por
tanto, en algún momento se abandona su mantenimiento, bien porque se ha
...
a las aplicaciones individuales ajenas a *Microsoft*. En muchos casos, las
propias aplicaciones comprueban al ejecutarse si existen versiones más modernas
y sugieren su instalación en caso de que así sea.
...
- Las :dfn:`distribuciones con versión estable`, que son aquellas en que cada
  ...
  + Ubuntu_ libera versiones cada seis meses (en abril y en octubre) que tienen
    ...
    La última, por tanto, a fecha de esta redacción es la *20.4*.
