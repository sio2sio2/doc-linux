...
**Supercookies**
   ...
   + El primer dominio sirve para saber si el navegador accede por primera vez;
     y el resto de dominios, para generar la el identificador único.
...
**Huella digital**
   ...
   .. seealso:: Es interesane el complemento `AmIUnique
...
+ Usar el gestor de contraseñas, sabiendo que:
  ...
  * Chromium_ no tiene contraseña maestra, y en *Windows* no hay forma de
    protegerlas, pero en *Linux* este navegador es capaz de utilizar
    ...
    .. seealso:: Chromium_ identifica por las variables de entorno si se encuentra
       ...
       contraseñas. La comprobación de que las contraseñas se almacenan cifradas
       puede consultar en `este artículo sobre el tema
