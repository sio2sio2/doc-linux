...
**Dispositivos magnéticos** (|CD|, |DVD|, *Blu-ray*),
...
**Memorias** o **pinchos** o **llaveros** |USB| o **pendrives**,
   ...
   (`memoria flash <https://es.wikipedia.org/wiki/Memoria_flash>`_) y que
...
* *Política de almacenamiento en equipos de trabajo*, que establecerá las normas
  ...
  + Cuánto tiempo puede almacernarse la información sin transferirla a los
...
* *Política de almacenamiento en la nube*, que debe recoger:
  ...
  + Qué requisitos debe cumplir un servicio en la nuble para que pueda ser
