...
**Controles biométricos**
   ...
   de una persona a través de una o varias de sus características físcias
   únicas:
   ...
   * *Reconocimientp vascular* (del dedo o de la mano), esto es, el
   ...
   * *Escritura* y *firma*.
   ...
   + *Atacabilidad*, esto es, la facilidad de prestarse a fraudes. Por ejemplo,
     ...
     distinguir la caura de un individuo de una fotografía del propio individuo
   ...
   + Los robos de patrones o muestras biométricas son irreversibles, ya que ha
...
------------------------
La autenticación puede llevarse a cabo mediante la aplicación de la criptografía
asimétrica. La exposición de este epígrafe se encuentra en el :ref:`epígrafe
sobre autenticación del apendice dedicado a la Criptograia <auth-crypto>`.
