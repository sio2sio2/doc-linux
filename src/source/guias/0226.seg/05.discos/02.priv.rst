...
|EFS| es la característica del sistema de archivos |NTFS| que implementa el
cifrado.

.. rubric:: Veracrypt

Tiene la ventaja de que es *software* libre y nos permite implementar las otras
tres estrategias. En `este artículo de redeszone.net sobre Veracrypt
<https://www.redeszone.net/tutoriales/seguridad/veracrypt-cifra-archivos-gratis/>`_
se puede encontrar la explicación para dos de ellas.

.. rubric:: BitLocker

Es la herramienta proporcionada por el propio *Windows* para el cifrado (aunque
no se incluye en las versiones *Home*). También permite implementar las otras
tres estrategias.
...
.. https://www.dell.com/support/kbdoc/es-es/000125409/como-activar-o-desactivar-bitlocker-con-tpm-en-windows
   ...
   https://www.itpro.com/security/encryption/359167/how-to-encrypt-files-and-folders-in-windows-10
