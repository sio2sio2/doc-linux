...
+ Deducir de la clave pública que permite verificar la firma la identidad del
  firma con total seguridad, ya que ésta está refrendada (o sea, firmada a su
  vez) por una autoridad de certificación.
...
Sea como sea, las |CA| generarn certificados finales:
