...
un almacén |NSS| y los certificados del sistema operativo. Se puede, no
obstante, preparar un catálogo de certificados que contenga la cadena de
certificados tal como se expone :ref:`al tratar los catálogos NSS <cert-nss>` y
hacer entonces la comprobación::
