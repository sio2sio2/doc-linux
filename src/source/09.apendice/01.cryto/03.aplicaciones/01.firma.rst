...
independiente, sino incrustada en el propio archivo.
...
identificativos. Si esta autoridad de certificación (|CA|) es de absoluta
...
su vez está firmado por `Digital Signature Trust`_, que sí es una |CA| raíz::
...
sino uno o varios nombres, por lo que si consultasmos uno (tal como se explica
...
.. note:: Tenga presente que, aunque descritos dentro de la configuración de un
   servidor wbe, estos certificados X.509 son válidos para cualquier protocolo
