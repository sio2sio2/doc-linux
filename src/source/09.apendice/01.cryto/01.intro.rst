...
Aplicaciones
============
Para la consecución de los objetivos anteriores la criptografía se aplica
en dos tareas distintas que pueden o no concurrir:

#. El **cifrado** de la información, para mantener su *secreto* y que permite
   combatir las consecuencias de la *intercepción* del mensaje (*privacidad*).

#. La **firma digital** con objeto de certificar la *veracidad* de la identidad
   del emisor y la *integridad* del contenido del mensaje (*autenticidad* e
   *integridad*). 
