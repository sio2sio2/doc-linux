...
desplazamiento de tres posiciones. En nuestro paús, también `Felipe II
...
#. La **suplantación** de la identidad del receptor, esto es, que el emisor crea
   que se está comunicación con alguien, cuado en realidad se está comunicando
   con otro que se hace pasar por él.

Debido a estos dos riesgos, la *criptografía* persigue aegurarse de lo
siguiente:
