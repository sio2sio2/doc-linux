...
- Transmitiendo previamente la clave en claro, lo cual puede provocar que se
  intercepte y sea inútil el cifrado posterior.
...
Básicamente, consiste en utilizar el cifrado asimétrico exclusivamente sobre una
clave simétrica, la cual se utiliza para cifrar la información que queremos
ocultar. De este modo, por ejemplo:
...
+ En un comunicación, utilizamos en una primera fase cifrado asimétrico para
  establecer un canal seguro para poder transmitir al otro extremo una clave
  simétrica, denominada :dfn:`clave de sesión`. Una vez que esta clave esté en
  ambos extremos, podemos proseguir la comunicación utilizando cifrado
