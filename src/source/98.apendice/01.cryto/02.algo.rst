...
y cifrar), sino un conjunto de acciones que permiten asegurar la identidad del
emisor y la integridad del mensaje. Esquemáticamente, firmar es la operación
resultante de:
...
.. seealso:: Más adelante se se hace una primera aproximación :ref:`a la firma
   digital <pra-firma>` intentando poner en práctica estos conceptos. Tenga
   presente, no obstante, que en la realidad la firma se lleva a cabo mediante
   estándares que se expondrán :ref:`al firmar documentos PDF <firm-doc>` o
   :ref:`firmar mensajes de correo electrónico <email-seguro>`.
