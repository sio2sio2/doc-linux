...
.. [#] Este procedimiento no es apropiado para firmar, porque en la realidad la
   ...
   Todo esto se analizará al tratar los `certificados digitales <cert-digital>`.
   Como no son eternas, cobra también importancia cuándo se firma, puesto que
   una firma válida sólo lo podrá ser dentro del periodo de tiempo en que las
   claves son válidas. En este procedimiento manual que hemos llevado a cabo no
   hay fechas (ni las claves tienen vigencia ni se sabe cuándo se ha llevado a
   cabo la firma). En consecuencia, no es un procedimiento adecuado para firmar
   con garantías.
