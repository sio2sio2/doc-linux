...
#. Para obtener la cadena completa de certificados en cambio basta con añadir
   la opción :kbd:`-showcerts`::
   ...
   que generará los archivos :file:`cert01`, :file:`cert02`, etc. El archivo :file:`cert00`
   no contendrá certificado alguno, sino la anterior al primer certificado.
