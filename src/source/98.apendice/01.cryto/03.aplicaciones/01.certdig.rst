...
.. note:: El resto del epígrafe se centra en esta segunda estrategia
   jerárquica. Las primera estrategia sólo es ampliamente utiliza en el correo
   electrónico, por lo que la trataremos al hablar sobre :ref:`el cifrado y la
   firma de mensajes de correo electrónico <email-seguro>`.
