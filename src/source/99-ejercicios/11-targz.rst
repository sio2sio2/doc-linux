...
#. Copiar el contenido de :file:`/var/log/syslog` en :file:`Db/syslog`.
...
9. Obtener del paquete anterior el fichero :file:`copìa.syslog` y dejarlo en el
   directorio actual de trabajo.


10. Empaquetar comprimiendo con :program:`gzip` el árbol de directorios
    anterior, pero excluir del paquete los ficheros :file:`syslog` (todos) y
    :file:`f3.xxx`.
